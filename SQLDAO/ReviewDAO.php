...
class ReviewDAO 
{
    ...
    {
        try {
            $query = "SELECT sum(r.rating)/ count(review_id) as average ,  count(review_id) as quantity as c FROM " . $this->tableName . " r WHERE review_guardian_id=:guardianId  AND active=true ";
